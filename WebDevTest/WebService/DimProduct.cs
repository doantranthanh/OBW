...
namespace WebService
{
    ...
    public partial class DimProduct
    {
        public DimProduct()
        {
            this.FactAdditionalInternationalProductDescriptions = new HashSet<FactAdditionalInternationalProductDescription>();
        ...
        public virtual ICollection<FactAdditionalInternationalProductDescription> FactAdditionalInternationalProductDescriptions { get; set; }
